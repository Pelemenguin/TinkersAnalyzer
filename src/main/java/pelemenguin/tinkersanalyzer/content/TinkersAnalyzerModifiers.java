...
import pelemenguin.tinkersanalyzer.content.modifier.SimpleAnalyzerModifier;
...
public final class TinkersAnalyzerModifiers {
    ...
    public static final StaticModifier<SimpleAnalyzerModifier> ENTITY_RADAR = MODIFIERS.register("entity_radar", () -> new SimpleAnalyzerModifier(
            TinkersAnalyzerItems.ENTITY_RADAR.get().graphUuid,
            TinkersAnalyzerItems.ENTITY_RADAR.get().graphId
        ));
