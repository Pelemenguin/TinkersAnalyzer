...
public final class TinkersAnalyzerClient {
    ...
    public static void init() {
        ...
        AnalyzerLayoutConfig.init(configSpecBuilder);
        AnalyzerRenderConfig.init(configSpecBuilder);

        CONFIG_SPEC = configSpecBuilder.build();

        ModLoadingContext.get().registerConfig(Type.CLIENT, CONFIG_SPEC);
    }
